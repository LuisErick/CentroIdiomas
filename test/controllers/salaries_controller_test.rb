...
class SalariesControllerTest < ActionController::TestCase
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post :create, salary: { amount: @salary.amount, hours: @salary.hours, teacher_attendance_id: @salary.teacher_attendance_id }
    end
  ...
  test "should update salary" do
    patch :update, id: @salary, salary: { amount: @salary.amount, hours: @salary.hours, teacher_attendance_id: @salary.teacher_attendance_id }
    assert_redirected_to salary_path(assigns(:salary))
  end
