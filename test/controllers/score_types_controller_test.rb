...
class ScoreTypesControllerTest < ActionController::TestCase
  ...
  test "should create score_type" do
    assert_difference('ScoreType.count') do
      post :create, score_type: { description: @score_type.description, noun: @score_type.noun, weight: @score_type.weight }
    end
  ...
  test "should update score_type" do
    patch :update, id: @score_type, score_type: { description: @score_type.description, noun: @score_type.noun, weight: @score_type.weight }
    assert_redirected_to score_type_path(assigns(:score_type))
  end
