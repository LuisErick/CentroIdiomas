...
class TeacherAttendancesControllerTest < ActionController::TestCase
  ...
  test "should create teacher_attendance" do
    assert_difference('TeacherAttendance.count') do
      post :create, teacher_attendance: { arrival_time: @teacher_attendance.arrival_time, dismissal_time: @teacher_attendance.dismissal_time, package_id: @teacher_attendance.package_id, state_id: @teacher_attendance.state_id }
    end
  ...
  test "should update teacher_attendance" do
    patch :update, id: @teacher_attendance, teacher_attendance: { arrival_time: @teacher_attendance.arrival_time, dismissal_time: @teacher_attendance.dismissal_time, package_id: @teacher_attendance.package_id, state_id: @teacher_attendance.state_id }
    assert_redirected_to teacher_attendance_path(assigns(:teacher_attendance))
  end
