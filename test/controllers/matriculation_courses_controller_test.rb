...
class MatriculationCoursesControllerTest < ActionController::TestCase
  ...
  test "should create matriculation_course" do
    assert_difference('MatriculationCourse.count') do
      post :create, matriculation_course: { final_grade: @matriculation_course.final_grade, level_id: @matriculation_course.level_id, package_id: @matriculation_course.package_id }
    end
  ...
  test "should update matriculation_course" do
    patch :update, id: @matriculation_course, matriculation_course: { final_grade: @matriculation_course.final_grade, level_id: @matriculation_course.level_id, package_id: @matriculation_course.package_id }
    assert_redirected_to matriculation_course_path(assigns(:matriculation_course))
  end
